...
import { useSettingsStore, FONT_SIZE_RANGE, LINE_HEIGHT_RANGE, FURIGANA_MODES, MANGA_SPREAD_MODES } from "@/stores/settings-store";
 ...
 */
export function ReaderSettingsPanel({ open, onOpenChange, fixedLayout = false }) {
