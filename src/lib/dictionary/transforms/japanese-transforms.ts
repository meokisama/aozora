...
// Ported from Yomitan's ja/japanese-transforms.js (rule data unchanged); only
// the import paths and TypeScript type annotations have been adapted.
import { suffixInflection, wholeWordInflection } from "./language-transforms";
import type { LanguageTransformDescriptor, Rule, SuffixRule } from "./types";
...
function irregularVerbSuffixInflections(
  suffix: "て" | "た" | "たら" | "たり",
...
function specialHonorificMasuInflections(conditionsIn: Condition[], conditionsOut: Condition[]): Rule<Condition>[] {
...
export const japaneseTransforms = {
  ...
  transforms: {
    ...
    "-ちゃう": {
      name: "-ちゃう",
      description:
        "Contraction of -しまう.\n" + shimauEnglishDescription + "Usage: Attach しまう after the て-form of verbs, contract てしまう into ちゃう.",
      i18n: [
        {
          language: "ja",
          name: "～ちゃう",
    ...
    "-ちまう": {
      name: "-ちまう",
      description:
        "Contraction of -しまう.\n" + shimauEnglishDescription + "Usage: Attach しまう after the て-form of verbs, contract てしまう into ちまう.",
      i18n: [
        {
          language: "ja",
          name: "～ちまう",
    ...
    "-しまう": {
      name: "-しまう",
      description: shimauEnglishDescription + "Usage: Attach しまう after the て-form of verbs.",
      i18n: [
        {
          language: "ja",
          name: "～しまう",
      ...
      rules: [suffixInflection("てしまう", "て", ["v5"], ["-て"]), suffixInflection("でしまう", "で", ["v5"], ["-て"])],
    },
    "-なさい": {
      name: "-なさい",
    ...
    "-く": {
      ...
      rules: [suffixInflection("く", "い", ["-く"], ["adj-i"])],
    },
    causative: {
      name: "causative",
      description:
    ...
    "-さ": {
      ...
      rules: [suffixInflection("さ", "い", [], ["adj-i"])],
    },
    passive: {
      name: "passive",
      description: passiveEnglishDescription + "Usage: Attach れる to the irrealis form (未然形) of godan verbs.",
      i18n: [
        {
          language: "ja",
          name: "～れる",
    ...
    "-き": {
      ...
      rules: [suffixInflection("き", "い", [], ["adj-i"])],
    },
    "-げ": {
      name: "-げ",
      ...
      rules: [suffixInflection("げ", "い", [], ["adj-i"]), suffixInflection("気", "い", [], ["adj-i"])],
    },
    "-がる": {
      name: "-がる",
      description:
      ...
      rules: [suffixInflection("がる", "い", ["v5"], ["adj-i"])],
    },
    "-やがる": {
      name: "-やがる",
      description:
        "Vulgar auxiliary showing contempt, irritation, or hostility toward the subject.\n" +
...
} satisfies LanguageTransformDescriptor<Condition>;
