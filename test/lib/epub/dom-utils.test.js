...
describe("getCharacterCount", () => {
  ...
  it("counts a gaiji image as one character", () => {
    const img = el('<img class="gaiji">', "p").firstChild;
